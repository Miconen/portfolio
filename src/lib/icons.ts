...
const glyphs: Record<string, SkillIcon> = {
	Go: siGo, TypeScript: siTypescript, Python: siPython, Rust: siRust, PHP: siPhp, JavaScript: siJavascript,
	Lua: siLua, Shell: siGnubash, SvelteKit: siSvelte, 'Next.js': siNextdotjs, Angular: siAngular,
	Tailwind: siTailwindcss, 'Node.js': siNodedotjs, '.NET': siDotnet, PostgreSQL: siPostgresql, MySQL: siMysql,
...
export function iconFor(skill: string): SkillIcon {
	return glyphs[skill] ?? { mono: monograms[skill] ?? skill.slice(0, 2) };
}
